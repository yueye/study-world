...
public class SxProducer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 订单列表
        List<OrderStep> orderList = new SxProducer().buildOrders();
        ...
        for (int i = 0; i < 10; i++) {
            ...
            Message msg = new Message(Constans.ROCKETMQ_TOPIC, tags[i % tags.length], "KEY" + i, body.getBytes());
